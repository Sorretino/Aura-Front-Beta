                        ...
                        <div className="space-y-8">
                            <div className="space-y-4">
                                ...
                                <h1 className="text-4xl lg:text-6xl font-bold text-foreground leading-tight">
                                    {t.heroTitle}
                                    <span className="text-CustonCabe">
                                        {""}
            ...
            <section id="pricing-section" className="py-20">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center space-y-4 mb-16">
                        ...
                        <h2 className="text-3xl lg:text-4xl font-bold text-CustonCabe">
                            {t.pricingTitle}{""}
                    ...
                    <div className="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
                        ...
                        <Card className="border-2 border-border hover:border-rose-500/50 transition-colors from-neutral-900 to-neutral-950 h-full">
                        ...
                        {/* Professional Plan */}
                        <Card
                            className="relative rounded-xl from-neutral-900 to-neutral-950 h-full transition-colors border-CustonCabe border-2"
                        // className="border-2 border-CustomBtnGreen relative hover:border-primary/80 transition-colors"
                        >
                            <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                                <Badge className="bg-CustonCabe text-primary-foreground px-4 py-1">
                                    {t.popular}
                                </Badge>
                            </div>
                            <CardHeader className="text-center pb-8">
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <Button
                                    ...
                                    // }}
                                    className="w-full mt-8 bg-CustonCabe text-primary-foreground"
                                >
                                    Começar Teste
                                </Button>
                            </CardContent>
                        ...
                        {/* Enterprise Plan */}
                        <Card className="border-2 border-border hover:border-indigo-600/50 transition-colors from-neutral-900 to-neutral-950 h-full">
                            <CardHeader className="text-center pb-8">
